...
("What element was discovered in 1996?", "Flerovium", "Roentgenium", "Darmstadtium", "Copernicium", "Copernicium", "90s Trivia"),
("The New York Yankees won the 1996 World Series, beating what team 3-2 in game 6 for their first world championship in 18 years?", "Atlanta Braves", "Boston Red Sox", "New York Yankees", "Minnesota Twins", "Atlanta Braves", "90s Trivia"),
...
("What is the largest country on Earth?", "United States", "China", "Russia", "Australia", "Russia", "World Geography"),
...
("What is the largest ocean on Earth?", "Atlantic Ocean", "Arctic Ocean", "Pacific Ocean", "Indian Ocean", "Pacific Ocean", "World Geography"),
...
("What do you call a group of Donkeys?", " a pace", "An army", "A troop", "A chain", "A pace", "Animals"),
...
("Which superhero  was the first Marvel Comics superhero?", "Human Torch", "Thor", "Spider Man", "Captain Marvel", "Human Torch", "Cartoons"),
...
("Which is the name of the shrunken city in a bottle in the Superman comics?", "Krypton", "Argo City", "Kandor", "Daxam", "Kandor", "Cartoons"),
("Which comic character was killed by dynamite?", "Batgirl", "Kid Flash", "Superboy", "Robin", "Robin", "Cartoons"),
...
("How often does the epidermis, the outer layer of the skin, replace itself?", "Once every 6 months", "Once every 4 weeks", "Once every 6 weeks", "Once every 3 months", "Once every 4 weeks", "Medical"),
("How many muscles are in the human ear?", "12", "9", "6", "16", "6", "Medical"),
...
("The world's busiest McDonald's is located in what city?", "Beijing", "Moscow", "Tokyo", "Pyongyang", "Moscow", "Funny"),
...
("What is the second best selling spice in the world?", "Mustard", "Pepper", "Salt", "Cinnamon", "Pepper", "Food"),
